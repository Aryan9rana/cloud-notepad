    ...
    <div className="modal-content">
      ...
      <form>
                <div className="mb-3">
                    ...
                    <input name="etitle" className="form-control form-control-lg" type="text" placeholder="Title" aria-label=".form-control-lg example" onChange={onChange} value={note.etitle}/>
                </div>
                <div className="mb-3">
                    <label htmlFor="exampleInputDescription" className="form-label">Description</label>
                    <input name="edescription" className="form-control form-control-lg" type="text" placeholder="Enter note here" aria-label=".form-control-lg example" onChange={onChange}value={note.edescription}/>
                </div>
                <div className="mb-3">
